...
msg 'Clearing Mail Download Attachments'
...
if [ -d ~/Library/Application\ Support/Firefox/ ]; then
  msg 'Clearning Firefox Cache Files...'
  sudo rm -rfv ~/Library/Application\ Support/Firefox/Crash\ reports/* &>/dev/null
fi
...
msg 'Deleting iOS Device Backups...'
...
# Delete all Visual Studio Code Caches and resets it to default
if [ -d ~/Library/Application\ Support/Code ]; then
	msg 'Cleaning Visual Studio Code logs and caches...'
	sudo rm -rfv ~/Library/Application\ Support/Code/Cache &>/dev/null
	sudo rm -rfv ~/Library/Application\ Support/Code/blob_storage &>/dev/null
	sudo rm -rfv ~/Library/Application\ Support/Code/CachedData &>/dev/null
	sudo rm -rfv ~/Library/Application\ Support/Code/Backups &>/dev/null
	sudo rm -rfv ~/Library/Application\ Support/Code/*logs*.txt &>/dev/null
	sudo rm -rfv ~/Library/Application\ Support/Code/Code\ Cache &>/dev/null
fi 

#Bash History 
echo "Cleaning Bash History"
sudo rm -rf /var/root/.sh_history
rm -rf ~/.bash_history
rm -rf ~/.bash_sessions/*

#Terminal Caches
echo "Clearing Terminal Caches"
...
do 
    msg "Cleaning ${GREEN}$x${NOFORMAT} Caches"
